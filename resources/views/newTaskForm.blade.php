        ...
        <div class="container">
            <form action="{{route('createNewTask')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" name="title"  placeholder="Insira o titulo da tarefa.">
                </div>

                <div class="form-group">
                    <label for="expectedDate">Data prevista para conclusão</label>
                    <input type="text" class="form-control date" data-provide="datepicker" id="expectedDate" name="expectedDate"  placeholder="Insira a data prevista de conclusão da tarefa.">
                </div>

                <div class="form-group">
                    <label for="taskOwner">Dono da tarefa</label>
                    <select class="form-control" id="taskOwner" name="taskOwner">
                        @foreach($currentUser as $obj)
                ...
                <div class="form-group">
                    ...
                    <textarea type="text-area" class="form-control" id="taskDescription" name="taskDescription" placeholder="Insira a descrição da tarefa."></textarea>
                </div>
